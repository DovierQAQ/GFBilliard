...
public class Board implements Drawable, Movable, ConfigReader.ConfigItem {
    ...
    public Board(double canvasDimX, double canvasDimY) {
        this.shape = new Rectangle(0, canvasDimY - 3 * HEIGHT, LENGTH, HEIGHT);
        this.shape.setFill(Color.valueOf("red"));
        bounds[0] = canvasDimX;
        bounds[1] = canvasDimY;
    }
